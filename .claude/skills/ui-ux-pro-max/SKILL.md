...
The search script lives inside this skill's own directory. Paths below are relative to the repository root — run them from there, or prefix them with the repo root if your working directory is elsewhere:

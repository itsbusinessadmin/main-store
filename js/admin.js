...
(function () {
  ...
  async function viewSettings(m) {
    const F = {
      ...
      hero_kicker: S.settings?.hero_kicker || "",
      hero_heading: S.settings?.hero_heading || "",
      hero_subheading: S.settings?.hero_subheading || "",
      hero_cta_text: S.settings?.hero_cta_text || "",
      hero_images: [...(S.settings?.hero_images || [])],
      ...
      try {
        await api.storeSaveSettings({
          ...
          settings: {
            ...
            hero_kicker: F.hero_kicker, hero_heading: F.hero_heading, hero_subheading: F.hero_subheading,
            hero_cta_text: F.hero_cta_text, hero_images: F.hero_images.filter(Boolean)
          }
        });
        ...
        Object.assign(S.settings, {
          ...
          hero_kicker: F.hero_kicker, hero_heading: F.hero_heading, hero_subheading: F.hero_subheading,
          hero_cta_text: F.hero_cta_text, hero_images: F.hero_images
        });
    ...
    mount(m,
      ...
      el("div", { class: "card" },
        el("div", { class: "card-h" }, el("h3", {}, "Hero section"),
          el("span", { class: "xs muted" }, "The big banner customers see first")),
        el("div", { class: "field" }, el("label", {}, "Kicker"),
          el("input", { class: "input", value: F.hero_kicker, placeholder: "e.g. All food. All good.",
            oninput: e => F.hero_kicker = e.target.value }),
          el("div", { class: "hint" }, "Small line above the headline. Optional.")),
        el("div", { class: "field" }, el("label", {}, "Headline"),
          el("textarea", { class: "textarea", style: "min-height:74px",
            placeholder: "e.g. Good food, made easy.", oninput: e => F.hero_heading = e.target.value }, F.hero_heading),
          el("div", { class: "hint" }, "Start a new line where you want the text to break. Leave blank to use your business name.")),
        el("div", { class: "field" }, el("label", {}, "Subheading"),
          el("textarea", { class: "textarea", placeholder: "A sentence or two under the headline.",
            oninput: e => F.hero_subheading = e.target.value }, F.hero_subheading),
          el("div", { class: "hint" }, "Leave blank to use your tagline instead.")),
        el("div", { class: "field" }, el("label", {}, "Button text"),
          el("input", { class: "input", value: F.hero_cta_text, placeholder: "Shop now",
            oninput: e => F.hero_cta_text = e.target.value })),
        el("div", { class: "field" }, el("label", {}, "Hero photos"),
          imageListPicker({ value: F.hero_images, label: "Add a hero photo", maxPx: 1600, max: 8,
            onChange: v => F.hero_images = v }),
          el("div", { class: "hint" }, "Shown as a swipeable gallery. Leave empty to show a text-only hero."))),

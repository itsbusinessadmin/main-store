...
(function (w) {
  ...
  function seed() {
    ...
    const settings = {
      ...
      hero_kicker: "All handmade. All good.",
      hero_heading: "Good things,\nmade with care.",
      hero_subheading: "From calming balms to everyday essentials, there's always something good waiting for you at Verde & Co.",
      hero_cta_text: "Shop now",
      hero_images: [IMG("#2f5d43", "#a8c3a0"), IMG("#8a7b5e", "#e6dcc6"), IMG("#3b4a52", "#c9d6db")],
      contact: [
  ...
  const storeSettings = id => db.settings.find(x => x.store_id === id) ||
    (db.settings.push({ store_id: id, logo_file_id: "", accent_color: "#173d24", announcement: "", tagline: "",
      hero_kicker: "", hero_heading: "", hero_subheading: "", hero_cta_text: "", hero_images: [], contact: [] }), db.settings.at(-1));
  ...
  function publicStorePayload(s) {
    ...
    return {
      ...
      hero_subheading: st.hero_subheading || "", hero_cta_text: st.hero_cta_text || "",
      hero_images: st.hero_images || [],
  ...
  const handlers = {
    ...
    store_signup: (p) => {
      ...
      db.stores.push(s);
      db.settings.push({ store_id: s.store_id, logo_file_id: "", accent_color: "#173d24", announcement: "", tagline: "",
        hero_kicker: "", hero_heading: "", hero_subheading: "", hero_cta_text: "", hero_images: [], contact: [] });

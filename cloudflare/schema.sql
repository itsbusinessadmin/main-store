...
CREATE TABLE IF NOT EXISTS store_settings (
  ...
  hero_kicker      TEXT DEFAULT '',     -- small eyebrow line above the hero heading, e.g. "All food. All good."
  hero_heading     TEXT DEFAULT '',     -- big landing headline; blank = falls back to business_name
  hero_subheading  TEXT DEFAULT '',     -- landing paragraph; blank = falls back to tagline
  hero_cta_text    TEXT DEFAULT '',     -- CTA button label; blank = falls back to "Shop now"
  hero_images      TEXT DEFAULT '[]'    -- JSON array of file ids, shown as a swipeable hero gallery
);
